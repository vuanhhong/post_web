...
<body>
    ...
    <script>
        ...
        function uploadImageToServer(file, callback) {
            ...
            xhr.open('POST', '<?= $baseUrl ?>/src/views/post/upload_image.php', true); // Gửi yêu cầu POST tới API upload_image.php
            xhr.onload = function() {
                ...
                if (file) {
                    uploadImageToServer(file, function(url) {
                        ...
                        quill.insertEmbed(range.index, 'image',
                            url); // Chèn ảnh vào vị trí con trỏ hiện tại trong editor
                    });
                }
            };
        }
        ...
        function submitQuillContent() {
            var html = quill.root.innerHTML.replace(
